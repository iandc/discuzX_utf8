...
$modarray = array('ajax', 'block', 'image', 'index', 'misc', 'redirect');
...
$url1 = urlencode("http://www.baidu.com/a.php?a=1&b=2&c=(c)");
$url2 = urlencode("http://www.baidu.com/a.php?a=3&b=4&d=(d)");

$content = '<p><a href="' . $url1 . '">url1</a>&nbsp;&nbps;<a href="' . $url2 . '">url2</a></p>';
echo 'before=' . $content;

echo "\r\n";

$content = preg_replace_url($content);
echo 'after=' . $content;
