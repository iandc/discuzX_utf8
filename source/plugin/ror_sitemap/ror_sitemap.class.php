...
class plugin_ror_sitemap_forum extends plugin_ror_sitemap
{    
    var $plugin_name = 'ror_sitemap';
    ...
    function viewthread_top_output()
    {
        ...
        $js = $settings['push_js'] ? $settings['push_js'] : '';
...
class plugin_ror_sitemap_portal extends plugin_ror_sitemap
{
    var $plugin_name = 'ror_sitemap';
...
class plugin_ror_sitemap_group extends plugin_ror_sitemap
{
    var $plugin_name = 'ror_sitemap';
