...
class table_forum_post extends discuz_table
{
    ...
    public function count_by_fid_dateline_invisible($tableid, $fid, $dateline, $invisible)
    {
        return DB::result_first('SELECT COUNT(*) FROM %t WHERE fid=%d AND dateline>=%d AND invisible=%d', array(self::get_tablename($tableid), $fid, $dateline, $invisible));
    }
